  ...
  <div className="pb-6 px-4" style={{ paddingTop: 'calc(var(--header-height) + 1rem)' }}>
        <div className="card-modern p-6">
          <div className="space-y-6">
            <div>
              <h2 className="text-lg font-semibold text-royal-gold font-playfair mb-3">1. Acceptance of Terms</h2>
              <p className="text-white/80 font-inter leading-relaxed">
                By accessing or using ShaadiMantrana ("Service"), you agree to be bound by these Terms of Condition ("Terms"), which form a legally binding agreement between you and ShaadiMantrana under the Indian Contract Act, 1872. If you do not agree with these Terms, you may not use the Service. These Terms are subject to applicable Indian laws, including but not limited to the Information Technology Act, 2000, and the Digital Personal Data Protection Act, 2023.
              </p>
            </div>

            <div>
              <h2 className="text-lg font-semibold text-royal-gold font-playfair mb-3">2. Service Description</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-royal-gold font-playfair mb-3">3. Free Service Commitment</h2>
              <p className="text-white/80 font-inter leading-relaxed mb-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-royal-gold font-playfair mb-3">4. Eligibility and Registration</h2>
              <p className="text-white/80 font-inter leading-relaxed mb-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-royal-gold font-playfair mb-3">5. User Responsibilities and Conduct</h2>
              <p className="text-white/80 font-inter leading-relaxed mb-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-royal-gold font-playfair mb-3">6. Prohibited Activities</h2>
              <p className="text-white/80 font-inter leading-relaxed mb-3">
            ...
            <div>
              ...
              <p className="text-white/80 font-inter leading-relaxed mt-3">
            ...
            <div className="pt-4 border-t border-royal-gold/20">
              ...
              <p className="text-sm text-royal-gold/60 mt-2">
                These Terms of Condition are effective immediately and govern your use of ShaadiMantrana in compliance with Indian laws.
              </p>
            </div>
          </div>
        </div>
