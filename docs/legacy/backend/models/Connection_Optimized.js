// Optimized Connection/Match Model - MongoDB Schema
...
const connectionSchema = new mongoose.Schema({
  ...
  // OPTIMIZED: Simplified compatibility score storage
  compatibility: {
    score: {
      type: Number,
      min: 0,
    ...
    // OPTIMIZED: Removed detailed factors to reduce document size
  },
...
// OPTIMIZED: Add TTL index for expired connections
