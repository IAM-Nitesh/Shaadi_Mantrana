...
MONGODB_URI=mongodb+srv://<REDACTED_USER>:<REDACTED_PASS>@cluster0-m0freetier.hdkszsj.mongodb.net/test?retryWrites=true&w=majority&appName=Cluster0-M0freeTier
...
| `SMTP_PASS` | Email app password | `<REDACTED_SMTP_PASS>` |
